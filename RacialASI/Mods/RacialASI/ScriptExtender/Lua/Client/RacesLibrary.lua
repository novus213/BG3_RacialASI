...
for _, raceMod in pairs(RaceList) do
	if raceMod.Guid == SearchedMod then
		...
		StringConstructed = "String = " ..
			"Ability(" .. StatsName[1] .. "," .. raceMod.Stats[1] .. "), " ..
			"Ability(" .. StatsName[2] .. "," .. raceMod.Stats[2] .. "), " ..
			"Ability(" .. StatsName[3] .. "," .. raceMod.Stats[3] .. "), " ..
			"Ability(" .. StatsName[4] .. "," .. raceMod.Stats[4] .. "), " ..
			"Ability(" .. StatsName[5] .. "," .. raceMod.Stats[5] .. "), " ..
			"Ability(" .. StatsName[6] .. "," .. raceMod.Stats[6] .. ")"
		print(StringConstructed)
	end
end