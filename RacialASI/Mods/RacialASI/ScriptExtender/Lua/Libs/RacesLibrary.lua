RaceLibrary = {
	...
	{
		Name			=	"Owlin",
		Guid			=	"c1e87b16-c845-4254-b831-bb22b13016fb", -- old "315ce1a1-0f24-4777-90d9-06b01a93a716",
...
-- ------------------------------------------------------------------ --
-- -------------------- CustomRaces.lua raceList -------------------- --
-- ------------------------------------------------------------------ --
	{
        Name			=	"Halfling (Haunted Warriors)",
        Guid			=	"f8f5f704-d463-4616-a321-9460060538ff",
    ...
    },
    {
        ...
        Guid			=	"68315895-8bd4-4d53-aefc-1b853ffc1461",
    ...
    },
    {
        ...
        Guid			=	"7a4aaaca-88a7-41c4-98d6-de2df39496fe",
    ...
    },
    {
        ...
        Guid			=	"5114d845-2c0f-441c-a01b-91a1847a48bc",
    ...
    },
    {
        ...
        Guid			=	"ae6eacb7-f346-418f-89a9-f0e4c697baab",
    ...
    {
        Name			=	"Followers Of Zerthimon (Githzerai)",
        Guid			=	"d6d1028e-68fb-4e94-83d8-e8951f55b86a",
        UUID			=	"8e8928df-70b1-43c0-bc86-40b32c455bee",
		Author			=	"",
		SourceBook		=	"",
		Stats			=	{"0", "0", "0", "1", "2", "0"}, --[[ "Strength", "Dexterity", "Constitution", "Intelligence", "Wisdom", "Charisma" ]]
    ...
    {
        Name			=	"Fey (Eladrin)",
        Guid			=	"abc09812-ed4d-43ff-9a93-ee46487e81d9",
    ...
    },
    {
        ...
        Guid			=	"ecfb9910-1b38-4bbc-a873-4f2812fff276",
    ...
    },
    {
        ...
        Guid			=	"7c7407ec-e2a8-4deb-a6dc-6cbc7bea2894",
    ...
    },
    {
        ...
        Guid			=	"1a3a0820-48e3-45b4-822a-7ee31e5d25c5",
    ...
    },
    {
        ...
        Guid			=	"0b1613ac-1610-4ac4-ba8b-effe33317fd1",
    ...
    },
    {
        ...
        Guid			=	"f13d31f7-c897-494c-a988-bca2a71ccddc",
    ...
    },
    {
        ...
        Guid			=	"9e7836a9-b1a9-4d4e-9089-563c43f4fb1e",
    ...
    },
    {
        ...
        Guid			=	"e61be041-6c93-4576-a4b1-ad183e726f02",
    ...
    },
    {
        ...
        Guid			=	"eaf83c50-1f22-4ce8-a825-25f07caf9faa",
    ...
    },
    {
        ...
        Guid			=	"ca81f091-bf1b-4bb6-90dd-1c4ef83fd798",
    ...
    {
        Name			=	"Yuan-ti",
        Guid			=	"b2d490bc-6e10-4bc2-89e0-69c8f68cd453",
    ...
    },
    {
        ...
        Guid			=	"f3d4e722-e576-43ce-a585-cfffcfcbcf40",
    ...
    },
    {
        ...
        Guid			=	"a56867c9-8260-4685-b8a5-6cc94be41152",
    ...
    },
    {
        ...
        Guid			=	"4b268977-b9ec-47fd-95e7-9b977969ba28",
    ...
    {
        Name			=	"Avariel_Ren",
        Guid			=	"11675ee8-a7be-443b-9edb-125f33d21ce1",
    ...
    },
    {
        ...
        Guid			=	"d25f0ed3-efe7-4194-bdc6-671f784d7cef",
    ...
    },
    {
        ...
        Guid			=	"76015234-1bb4-42dc-adb9-c86c7f4cbb39",
...
-- ------------------------------------------------------------------ --
-- --------------- Fantastastical multiverse raceList --------------- --
-- ------------------------------------------------------------------ --
	{
		Name 			=	"Variant Human - Fantastical",
		Guid			=	"5e53f556-ba7a-46fd-9dee-ba1ff456d8db",
	...
	},
	{
		...
		Guid			=	"e7071309-78a8-4fad-949b-d4dd326dd39b",
	...
	},
	{
		...
		Guid			=	"07a0478e-ba76-4fc7-a671-1c13c66ede2e",
	...
	},
	{
		...
		Guid			=	"21d14d75-2e99-4e85-82ad-7139c69b85fe",
	...
	},
	{
		...
		Guid			=	"3b7799fa-3dc0-47da-bf9f-fc590f7e2cdf",
	...
	},
	{
		...
		Guid			=	"f34c3aca-0b14-4001-af29-27e130cf5c5c",
	...
	},
	{
		...
		Guid			=	"9cbbf22a-2af4-48c7-970a-fb61a6c20b15",
	...
	},
	{
		...
		Guid			=	"4508d3bd-e721-47a4-894d-0e61c7b0380d",
	...
	},
	{
		...
		Guid			=	"95d5279b-e063-459d-81d2-d4fa0cec27ca",
	...
	},
	{
		...
		Guid			=	"6abf0f64-62d6-4e80-a141-5582e29783e7",
	...
	},
	{
		...
		Guid			=	"35fd2505-5eff-45c5-96e9-98d848f35da4",
	...
	},
	{
		...
		Guid			=	"3fe9bc5e-2723-4044-a06b-060aed98e40b",
	...
	},
	{
		...
		Guid			=	"2b5c5a5b-5da3-4c65-b852-92ff75dda75a",
	...
	},
	{
		...
		Guid			=	"410f1b65-e8a1-4f13-b4e8-ae25e5460a7e",
	...
	},
	{
		...
		Guid			=	"dc812cdf-7fdb-4372-81c7-72df0e00f542",
	...
	},
	{
		...
		Guid			=	"ff15d50f-57d4-48d9-80ce-0ee75a669010",
	...
	},
	{
		...
		Guid			=	"d41e6098-288c-49ba-a861-1ab082f8e4b9",
	...
	},
	{
		...
		Guid			=	"44aeee6c-5a35-4733-89a1-420451c6a559",
	...
	},
	{
		...
		Guid			=	"35e9d7e9-716d-4fdb-8b0b-6dac2526389d",
	...
	},
	{
		...
		Guid			=	"13871336-692e-4af3-9e52-68cdf58330fb",
	...
	},
	{
		...
		Guid			=	"41e6aeb8-e8ae-41b8-b303-8ad2f8b43f61",
	...
	},
	{
		...
		Guid			=	"bea5a09a-b394-4a52-9166-659cbc1bf183",
	...
	},
	{
		...
		Guid			=	"0cc2683d-c407-40d6-ad65-8c5f95d7ef4b",
